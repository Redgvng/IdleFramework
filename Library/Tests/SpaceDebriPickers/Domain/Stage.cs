...
namespace Pickers.Domain
{
    ...
    public interface IDebliCollection
    {
        double GetCollectedDebri(int tier);
        void IncrementDebri(int tier, double increment);
    }


    //デブリの情報と位置を全て格納する
    public class DebriInfo
    {
    ...
    public class Debri
    {
        ...
        public void OnCollide(Picker picker, IDebliCollection collection, DebriInfo debriInfo)
        {
            ...
            collection.IncrementDebri(this.tier, this.requiredInhalePower.Number);
...
namespace Pickers.Domain.Test
{
    ...
    //デブリの取得数を格納する
    public class DebriCollection : IDebliCollection
    {
        ...
        public void IncrementDebri(int tier, double value) => debrisCollected[tier] += value;
